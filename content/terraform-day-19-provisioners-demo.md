---
title: "Day 19: Terraform Provisioners Demo"
slug: terraform-day-19-provisioners-demo
category: Terraform
tags: terraform, aws, provisioners, ssh
excerpt: local-exec, remote-exec, and file provisioners — what each is for, why they're a "last resort" in Terraform's own words, and the alternatives (user_data, Packer, config management) worth reaching for first.
status: published
---

*Day 19 of a 26-part Terraform + AWS series.* ← [Day 18](/blog/terraform-day-18-image-processor-backend) · → [Day 21: AWS Policy and Governance](/blog/terraform-day-21-policy-and-governance)
