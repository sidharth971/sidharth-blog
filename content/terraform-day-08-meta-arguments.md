---
title: "Day 8: Terraform Meta-Arguments - Complete Guide"
slug: terraform-day-08-meta-arguments
category: Terraform
tags: terraform, aws, count, for-each, depends-on, lifecycle
excerpt: A complete tour of Terraform meta-arguments — count, for_each, depends_on, lifecycle, and provider — with when to use each and count vs for_each compared head to head.
status: published
---

*Day 8 of a 26-part Terraform + AWS series.* ← [Day 7](/blog/terraform-day-07-type-constraints) · → [Day 9: Lifecycle Meta-Arguments](/blog/terraform-day-09-lifecycle-meta-arguments)
