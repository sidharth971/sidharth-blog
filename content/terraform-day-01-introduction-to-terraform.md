---
title: "Day 1: Introduction to Terraform"
slug: terraform-day-01-introduction-to-terraform
category: Terraform
tags: terraform, iac, aws, fundamentals
excerpt: What Infrastructure as Code actually buys you, what Terraform is, how its workflow (init/plan/apply/destroy) fits together, and getting it installed.
status: published
---

*Day 1 of a 26-part Terraform + AWS series.* → [Day 2: Terraform Provider](/blog/terraform-day-02-terraform-provider)
