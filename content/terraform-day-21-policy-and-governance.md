---
title: "Day 21: AWS Policy and Governance (Mini Project 7)"
slug: terraform-day-21-policy-and-governance
category: Terraform
tags: terraform, aws, iam, aws-config, compliance, mini-project
excerpt: Policy-as-code and continuous compliance — IAM policies (MFA delete, encryption in transit, required tags) paired with 7 AWS Config rules that monitor S3, EBS, IAM, and root account posture.
status: published
---

*Day 21 of a 26-part Terraform + AWS series.* ← [Day 19](/blog/terraform-day-19-provisioners-demo) · → [Day 22: RDS Database](/blog/terraform-day-22-rds-database)
