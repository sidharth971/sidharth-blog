---
title: "Day 23: S3 Security & Operations Monitoring (Mini Project)"
slug: terraform-day-23-s3-security-monitoring
category: Terraform
tags: terraform, aws, s3, cloudtrail, cloudwatch, monitoring, mini-project
excerpt: Wiring up CloudTrail data events, CloudWatch Logs metric filters, and alarms so you get an SNS email the moment someone hits a restricted S3 prefix or triggers repeated access-denied errors.
status: published
---

*Day 23 of a 26-part Terraform + AWS series.* ← [Day 22](/blog/terraform-day-22-rds-database) · → [Day 24: HA/Scalable Infrastructure](/blog/terraform-day-24-ha-scalable-infrastructure)
