---
title: "Day 9: Terraform Lifecycle Meta-arguments (AWS)"
slug: terraform-day-09-lifecycle-meta-arguments
category: Terraform
tags: terraform, aws, lifecycle, create-before-destroy, prevent-destroy
excerpt: Every lifecycle meta-argument in depth — create_before_destroy, prevent_destroy, ignore_changes, replace_triggered_by, precondition, and postcondition — with real use cases for each.
status: published
---

*Day 9 of a 26-part Terraform + AWS series.* ← [Day 8](/blog/terraform-day-08-meta-arguments) · → [Day 10: Dynamic Blocks & Expressions](/blog/terraform-day-10-dynamic-blocks-conditionals-splat)
