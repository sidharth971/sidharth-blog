---
title: "Day 27: AWS Production Infrastructure - Demo Guide"
slug: terraform-day-27-production-infrastructure
category: Terraform
tags: terraform, aws, alb, autoscaling, nat-gateway, mini-project
excerpt: A full 2-tier production demo — VPC across multiple AZs, ALB, Auto Scaling Group, NAT Gateway — walked through step by step from init to load-testing the autoscaler.
status: published
---

*Day 27 of a 26-part Terraform + AWS series.* ← [Day 24](/blog/terraform-day-24-ha-scalable-infrastructure) · → [Day 28: Goal Tracker 3-Tier Infrastructure](/blog/terraform-day-28-goal-tracker-3tier)
