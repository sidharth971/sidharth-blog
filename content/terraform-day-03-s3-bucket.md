---
title: "Day 3: S3 Bucket"
slug: terraform-day-03-s3-bucket
category: Terraform
tags: terraform, aws, s3, authentication
excerpt: Setting up AWS authentication for Terraform (CLI, env vars, IAM roles, profiles), then creating your first real resource — an S3 bucket.
status: published
---

*Day 3 of a 26-part Terraform + AWS series.* ← [Day 2](/blog/terraform-day-02-terraform-provider) · → [Day 4: State File Management](/blog/terraform-day-04-state-file-remote-backend)
