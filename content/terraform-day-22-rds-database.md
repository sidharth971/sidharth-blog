---
title: "Day 22: RDS Database (Mini Project 8)"
slug: terraform-day-22-rds-database
category: Terraform
tags: terraform, aws, rds, vpc, modules, mini-project
excerpt: A modular VPC + EC2 + RDS MySQL stack — a Flask app in public subnets talking to a database in private subnets, with security groups scoped to the web tier only.
status: published
---

*Day 22 of a 26-part Terraform + AWS series.* ← [Day 21](/blog/terraform-day-21-policy-and-governance) · → [Day 23: S3 Security & Monitoring](/blog/terraform-day-23-s3-security-monitoring)
