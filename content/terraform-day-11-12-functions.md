---
title: "Terraform Functions Learning Guide - AWS Edition (Day 11-12)"
slug: terraform-day-11-12-functions
category: Terraform
tags: terraform, aws, functions, hcl
excerpt: A two-day tour of Terraform's built-in functions across every category (string, numeric, collection, type conversion, file, date/time, validation, lookup) through 12 hands-on assignments.
status: published
---

*Days 11-12 of a 26-part Terraform + AWS series.* ← [Day 10](/blog/terraform-day-10-dynamic-blocks-conditionals-splat) · → [Day 13: Data Sources](/blog/terraform-day-13-data-sources)
...
- ✅ Ready for **[Day 13: Terraform Data Sources](/blog/terraform-day-13-data-sources)**
