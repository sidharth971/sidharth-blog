---
title: "Day 29: GitOps with ArgoCD in EKS Cluster with Kustomize"
slug: terraform-day-29-gitops-argocd-eks-kustomize
category: Terraform
tags: terraform, aws, eks, argocd, kustomize, gitops
excerpt: A full GitOps loop on EKS — Terraform provisions the cluster and installs ArgoCD, Kustomize manages the 3-tier app manifests, and ArgoCD auto-syncs on every git push. Uses EKS module v21 and access entries, not aws-auth.
status: published
---

*Day 29 of a 26-part Terraform + AWS series.* ← [Day 28](/blog/terraform-day-28-goal-tracker-3tier) · → [Day 30: Drift Detection & Auto-Remediation](/blog/terraform-day-30-drift-detection-auto-remediation)
