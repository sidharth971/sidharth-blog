---
title: "Day 6: File Structure"
slug: terraform-day-06-file-structure
category: Terraform
tags: terraform, aws, project-structure, best-practices
excerpt: How Terraform loads .tf files, a recommended file layout (backend/provider/variables/main/outputs), and full working example files for a VPC + S3 setup.
status: published
---

*Day 6 of a 26-part Terraform + AWS series.* ← [Day 5](/blog/terraform-day-05-terraform-variables) · → [Day 7: Type Constraints](/blog/terraform-day-07-type-constraints)
