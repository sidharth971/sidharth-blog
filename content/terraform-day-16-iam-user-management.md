---
title: "Day 16: AWS IAM User Management with Terraform"
slug: terraform-day-16-iam-user-management
category: Terraform
tags: terraform, aws, iam, csv, for-each
excerpt: Managing IAM users, groups, and group memberships from a CSV data source — for_each over parsed CSV rows, dynamic group membership by department, and console access setup.
status: published
---

*Day 16 of a 26-part Terraform + AWS series.* ← [Day 15](/blog/terraform-day-15-vpc-and-peering) · → [Day 17: Elastic Beanstalk Blue-Green](/blog/terraform-day-17-elastic-beanstalk-blue-green)
