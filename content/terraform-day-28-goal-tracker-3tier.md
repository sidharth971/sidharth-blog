---
title: "Day 28: Goal Tracker - 3-Tier AWS Infrastructure"
slug: terraform-day-28-goal-tracker-3tier
category: Terraform
tags: terraform, aws, docker, rds, secrets-manager, 3-tier, mini-project
excerpt: A real 3-tier app (Node.js frontend, Go backend, PostgreSQL) across 8 subnets, public and internal ALBs, a bastion host, and Secrets Manager for credentials.
status: published
---

*Day 28 of a 26-part Terraform + AWS series.* ← [Day 27](/blog/terraform-day-27-production-infrastructure) · → [Day 29: GitOps with ArgoCD](/blog/terraform-day-29-gitops-argocd-eks-kustomize)
