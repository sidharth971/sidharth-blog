---
title: "Day 13: Terraform Data Sources with AWS"
slug: terraform-day-13-data-sources
category: Terraform
tags: terraform, aws, data-sources, vpc
excerpt: Using data sources to reference existing AWS infrastructure — provisioning an EC2 instance into a pre-existing "shared" VPC and subnet without managing that network in your own Terraform config.
status: published
---

*Day 13 of a 26-part Terraform + AWS series.* ← [Day 11-12](/blog/terraform-day-11-12-functions) · → [Day 14: Static Website Hosting](/blog/terraform-day-14-static-website-hosting)
