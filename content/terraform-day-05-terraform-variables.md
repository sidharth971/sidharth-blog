---
title: "Day 5: Terraform Variables Demo"
slug: terraform-day-05-terraform-variables
category: Terraform
tags: terraform, aws, variables, locals, outputs
excerpt: The three types of Terraform variables — input, local, and output — demonstrated with a simple S3 bucket, plus variable precedence (CLI > tfvars > env vars > defaults).
status: published
---

*Day 5 of a 26-part Terraform + AWS series.* ← [Day 4](/blog/terraform-day-04-state-file-remote-backend) · → [Day 6: File Structure](/blog/terraform-day-06-file-structure)
