---
title: "Day 18: Simple Image Processor - Backend Only"
slug: terraform-day-18-image-processor-backend
category: Terraform
tags: terraform, aws, lambda, s3, serverless
excerpt: A serverless image-processing pipeline — S3 upload triggers a Lambda function (with a Pillow layer) that generates compressed, WebP, PNG, and thumbnail variants automatically.
status: published
---

*Day 18 of a 26-part Terraform + AWS series.* ← [Day 17](/blog/terraform-day-17-elastic-beanstalk-blue-green) · → [Day 19: Provisioners Demo](/blog/terraform-day-19-provisioners-demo)
