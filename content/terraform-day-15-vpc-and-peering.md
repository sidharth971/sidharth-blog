---
title: "Day 15: VPC and Peering (Mini Project 2)"
slug: terraform-day-15-vpc-and-peering
category: Terraform
tags: terraform, aws, vpc, peering, networking, mini-project
excerpt: Cross-region VPC peering between two VPCs — subnets, route tables, security groups, and provider aliases for multi-region deployments — plus how to actually test the connection end to end.
status: published
---

*Day 15 of a 26-part Terraform + AWS series.* ← [Day 14](/blog/terraform-day-14-static-website-hosting) · → [Day 16: IAM User Management](/blog/terraform-day-16-iam-user-management)
