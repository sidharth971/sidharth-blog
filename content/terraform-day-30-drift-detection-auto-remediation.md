---
title: "Day 30: Terraform Drift Detection & Auto-Remediation"
slug: terraform-day-30-drift-detection-auto-remediation
category: Terraform
tags: terraform, aws, drift-detection, github-actions, ci-cd
excerpt: Closing out the series — a scheduled GitHub Actions workflow that runs terraform plan on a timer, detects drift, auto-applies the fix, and posts to Slack/GitHub issues when it does.
status: published
---

*Day 30 of a 26-part Terraform + AWS series — the final post in this run.* ← [Day 29](/blog/terraform-day-29-gitops-argocd-eks-kustomize)
