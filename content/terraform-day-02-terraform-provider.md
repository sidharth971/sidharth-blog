---
title: "Day 2: Terraform Provider"
slug: terraform-day-02-terraform-provider
category: Terraform
tags: terraform, providers, aws, versioning
excerpt: What Terraform providers are, why the provider version and Terraform core version are independent, version constraint syntax, and best practices for pinning.
status: published
---

*Day 2 of a 26-part Terraform + AWS series.* ← [Day 1](/blog/terraform-day-01-introduction-to-terraform) · → [Day 3: S3 Bucket](/blog/terraform-day-03-s3-bucket)
